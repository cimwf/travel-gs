...
assert(tripHandler.includes("fetchPhase('upcoming', pageSize + 1"));
assert(tripHandler.includes("fetchPhase('past', pageSize + 1"));
assert(tripHandler.includes('nextCursorPhase'));
assert(tripHandler.includes("_id: _.lt(phaseCursorId)"));
